...
$script = new Script('foo', 'www.example.com/test-script.js');
$script->withCondition('gt IE 9'); // <!--[if gt IE 9]><script src="www.example.com/test-script.js"></script><![endif]-->
...
// <script src="test-script.js" id="my-handle-js" async data-value="key" nonce="{generated nonce}"></script>
